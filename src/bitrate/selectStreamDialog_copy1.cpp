...
selectStreamDialog_copy1::selectStreamDialog_copy1(Mk03::engineContainer<Mk03::bitrateAnalysis>* aPePtr,
                                                   QWidget* parent)
    : QDialog(parent), pePtr(aPePtr), ui(new Ui::selectStreamDialog_copy1) {
  ui->setupUi(this);
